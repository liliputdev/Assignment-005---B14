      ...
      <header className="sticky top-0 z-50 border-b border-gray-100 bg-white">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <a
              href="#"
              className="text-sm font-normal text-gray-900 hover:text-pink-500"
            >
              Home
            </a>
            ...
            <a
              href="#technologies"
              className="text-sm font-normal text-gray-600 hover:text-pink-500"
            >
              Technologies
            </a>
          ...
          <div className="hidden items-center gap-3 sm:flex">
            <button
              type="button"
              className="px-4 py-2 text-sm font-normal text-gray-700 hover:text-pink-500"
            >
              Sign In
            </button>
            ...
            <button
              type="button"
              className="rounded-full bg-[#DB1677] px-6 py-2.5 text-sm font-medium text-white hover:bg-[#C41269]"
            >
              Sign Up
            </button>
          </div>
                    ...
                    {stack.map((technology) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-xs text-[#94a3b8] hover:text-red-500"
                        >
                          ×
                        </button>
