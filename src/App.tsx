...
function App() {
  ...
  // Add technology
  const handleAddToStack = (technology: (typeof technologiesData)[number]) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <button
                  ...
                  className="rounded-lg bg-gradient-to-r from-orange-500 to-pink-500 px-6 py-3 text-base font-semibold text-white transition hover:opacity-90"
                >
                ...
                <button
                  ...
                  className="rounded-lg border border-gray-200 bg-white px-9 py-3 text-base font-normal text-gray-700 transition hover:border-gray-300"
                >
                  Learn More
                </button>
              </div>
        ...
        <section
          id="technologies"
          className="px-6 py-16 sm:px-8 lg:px-8"
        >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  {technologies.map((technology) => {
                    ...
                    return (
                      <div
                        key={technology.id}
                        className="flex min-h-[145px] flex-col rounded-xl border border-gray-100 bg-white p-3 transition hover:border-gray-200"
                      >
                        ...
                        {/* Description */}
                        <p className="mt-1 min-h-[30px] text-[8px] leading-3 text-[#718096]">
